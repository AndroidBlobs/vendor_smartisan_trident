...
LOCAL_MODULE := GFTest
LOCAL_MODULE_OWNER := smartisan
LOCAL_SRC_FILES := proprietary/vendor/app/GFTest/GFTest.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := NvtFprCommonService
LOCAL_MODULE_OWNER := smartisan
LOCAL_SRC_FILES := proprietary/vendor/app/NvtFprCommonService/NvtFprCommonService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
